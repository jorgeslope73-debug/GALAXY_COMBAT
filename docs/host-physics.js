  ...
  class GalaxyHostPhysics{
    ...
    publicState(){
      return{
        ...
        bullets:this.bullets.map(b=>({id:b.id,o:b.owner,x:+b.x.toFixed(1),y:+b.y.toFixed(1),vx:+b.vx.toFixed(1),vy:+b.vy.toFixed(1),g:!!b.guided,gt:Number.isInteger(b.target)?b.target:-1})),
