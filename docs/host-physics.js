      ...
      for(let i=this.bullets.length-1;i>=0;i--){
        ...
        if(!remove)for(const a of this.asteroids){
          if(sweptCircles(b,BULLET_RADIUS,a,a.r,false)){
            // Los asteroides grandes son indestructibles, pero el cohete guiado
            // explota visualmente en el punto exacto del impacto.
            if(b.guided){
        ...
        if(!remove&&this.giant&&sweptCircles(b,BULLET_RADIUS,this.giant,GIANT_RADIUS,false)){
          // El gigante tampoco se destruye: solo desaparece el cohete y se ve
          // la explosion del impacto sobre su superficie.
