  ...
  const DATA = {
    ...
    en: {
      ...
      sections:[
        ...
        {id:'pickups',title:'5. Floating upgrades',body:['Upgrades appear around the arena periodically. Up to 5 can exist at once. When the oldest one is about to be replaced, it blinks during its final 2 seconds between 50% and 100% opacity.','Asteroids and meteors can remove pickups by crossing them, so an opportunity may disappear before you reach it.'],pickups:[['ammo1','AMMO +1','Adds 1 bullet to your reserve.'],['ammo3','AMMO +6','Adds 6 bullets to your reserve.'],['cadence','FIRE RATE','Lets you fire more often; higher levels also speed up projectiles.'],['mira','AIM · GUIDED MISSILE','Turns your next shot into a guided missile. If you have 0 ammo, it also grants 1 bullet.'],['speed','SPEED','Raises ship speed in +0.5 steps up to x2.'],['shield','SHIELD','Protects for 10 s against shots and many collisions. A shielded ship can be dangerous in a ram.'],['camo','INVISIBILITY','Online only. Activates ghost mode for 10 s. Shown as a crossed-out eye.']]},
