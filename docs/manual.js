  ...
  const DATA = {
    es: {
      ...
      sections:[
        ...
        {id:'controls',title:'2. Controles',body:[
          ...
          'Móvil: juega en horizontal y elige ROTACIÓN o BOTONES. En ROTACIÓN, inclina el teléfono para girar y se calibra automáticamente al empezar. En BOTONES, usa las flechas izquierda/derecha del lado izquierdo. En ambos modos, en la zona derecha un toque rápido dispara y mantener pulsado acelera. En iPad con teclado físico, los controles de PC se activan automáticamente al pulsar A/D, flechas, W, CTRL o ESPACIO; al volver a tocar la pantalla recuperas el control móvil.',
        ...
        {id:'online',title:'10. Online, salas, chat y voz',body:[
          ...
          'Si te registras, tu nombre queda reservado solo para ti y tus partidas válidas cuentan para el ranking. Una partida con CPU de relleno también puntúa si hay al menos 2 jugadores humanos registrados; las CPU no aparecen en el ranking.',
    ...
    en: {
      ...
      sections:[
        ...
        {id:'controls',title:'2. Controls',body:['PC: A / D or Left / Right arrows to turn; W or Up arrow to thrust; CTRL or SPACE to fire. ESC leaves the match.','Mobile: play in landscape and choose TILT or BUTTONS. In TILT mode, tilt the phone to turn and it calibrates automatically at match start. In BUTTONS mode, use the left/right arrows on the left side. In both modes, on the right side a quick tap fires and holding thrusts. On iPad with a physical keyboard, PC controls activate automatically when you press A/D, arrows, W, CTRL or SPACE; touching the screen switches back to mobile controls.','Voice: enable it from the main menu. On PC hold V to talk. On mobile a voice control appears during the match; hold it while speaking.'],tips:['On mobile, hold the phone in your comfortable playing position before the match starts: that position becomes the reference.','Server controls expire if updates stop arriving, preventing stuck thrust or turning after a connection issue.']},
        ...
        {id:'weapons',title:'4. Ammunition, shots and BRUTAL',body:['You start a match with 5 bullets. Every shot consumes one ammo unit; collect capsules to keep attacking.','The fire-rate upgrade reduces the delay between shots. At advanced levels it also increases projectile speed, making an upgraded player much more dangerous.','A very long-range kill triggers BRUTAL. The game measures the distance travelled by the bullet and displays it in metres, using an 8 m ship as the reference. The current threshold is roughly 142 m.'],tips:['Do not waste your last bullet: with no ammo you lose your ranged threat until you find another capsule.','Bullets vanish outside the arena and can also destroy small meteors or remove floating pickups.']},
        {id:'pickups',title:'5. Floating upgrades',body:['Upgrades appear around the arena periodically. Up to 5 can exist at once. When the oldest one is about to be replaced, it blinks during its final 2 seconds between 50% and 100% opacity.','Asteroids and meteors can remove pickups by crossing them, so an opportunity may disappear before you reach it.'],pickups:[['ammo1','AMMO +1','Adds 1 bullet to your reserve.'],['ammo3','AMMO +6','Adds 6 bullets to your reserve.'],['cadence','FIRE RATE','Lets you fire more often; higher levels also speed up projectiles.'],['speed','SPEED','Raises ship speed in +0.5 steps up to x2.'],['shield','SHIELD','Protects for 10 s against shots and many collisions. A shielded ship can be dangerous in a ram.'],['camo','INVISIBILITY','Online only. Activates ghost mode for 10 s. Shown as a crossed-out eye.']]},
    ...
    it: {
      ...
      sections:[
        ...
        {id:'controls',title:'2. Comandi',body:['PC: A / D o frecce sinistra / destra per girare; W o freccia su per accelerare; CTRL o SPAZIO per sparare. ESC esce dalla partita.','Mobile: gioca in orizzontale e scegli ROTAZIONE o PULSANTI. In ROTAZIONE inclina il telefono per girare; in PULSANTI usa le frecce sinistra/destra sul lato sinistro. In entrambi i modi, sul lato destro un tocco rapido spara e tenere premuto accelera.','Voce: attivala dal menu. Su PC tieni premuto V per parlare. Su mobile compare un controllo vocale durante la partita; tienilo premuto mentre parli.'],tips:['Su mobile, tieni il telefono nella posizione comoda prima dell inizio: quella posizione diventa il riferimento.','I comandi sul server scadono se smettono di arrivare aggiornamenti, evitando accelerazione o rotazione bloccate.']},
        ...
        {id:'weapons',title:'4. Munizioni, colpi e BRUTAL',body:['Inizi con 5 proiettili. Ogni sparo consuma una munizione; raccogli capsule per continuare ad attaccare.','Il potenziamento cadenza riduce il tempo tra i colpi. Ai livelli avanzati aumenta anche la velocità del proiettile.','Un eliminazione da distanza molto lunga attiva BRUTAL. Il gioco misura il percorso del proiettile e lo mostra in metri usando una nave da 8 m come riferimento. La soglia attuale è circa 142 m.'],tips:['Non sprecare l ultima munizione: senza colpi perdi la minaccia a distanza finché non trovi una capsula.','I proiettili spariscono fuori dall arena e possono distruggere meteore piccole o eliminare potenziamenti.']},
    ...
    fr: {
      ...
      sections:[
        ...
        {id:'controls',title:'2. Commandes',body:['PC: A / D ou flèches gauche / droite pour tourner; W ou flèche haut pour accélérer; CTRL ou ESPACE pour tirer. ESC quitte la partie.','Mobile: joue en paysage et choisis ROTATION ou BOUTONS. En ROTATION, incline le téléphone pour tourner. En BOUTONS, utilise les flèches gauche/droite à gauche. Dans les deux modes, à droite une touche rapide tire et maintenir accélère.','Voix: active-la depuis le menu. Sur PC maintiens V pour parler. Sur mobile un contrôle vocal apparaît pendant la partie.'],tips:['Sur mobile, tiens le téléphone dans ta position de jeu confortable avant le départ: elle devient la référence.','Les commandes expirent côté serveur si les mises à jour cessent, évitant une accélération ou rotation bloquée.']},
    ...
    de: {
      ...
      sections:[
        ...
        {id:'controls',title:'2. Steuerung',body:['PC: A / D oder Pfeil links / rechts zum Drehen; W oder Pfeil hoch zum Beschleunigen; CTRL oder LEERTASTE zum Feuern. ESC verlässt das Spiel.','Mobil: spiele im Querformat und wähle NEIGUNG oder TASTEN. Bei NEIGUNG drehst du durch Kippen des Telefons. Bei TASTEN nutzt du links die Pfeile für links/rechts. In beiden Modi feuert rechts kurzes Tippen und Halten beschleunigt.','Sprache: im Hauptmenü aktivieren. Auf PC V gedrückt halten zum Sprechen. Mobil erscheint während des Spiels eine Sprechtaste.'],tips:['Halte das Telefon vor dem Start in deiner bequemen Spielposition; diese wird als Referenz genommen.','Serverseitige Steuerbefehle laufen aus, wenn keine Updates mehr eintreffen, damit Schub oder Drehung nicht hängen bleiben.']},
